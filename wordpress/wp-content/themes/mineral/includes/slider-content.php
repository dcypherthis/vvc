...
<div class="content-slider cols-wrapper cols-2" id="<?php echo $slider_div_id; ?>" >
	...
	<ul id="cs-slider-ul" style="min-height:<?php echo $slider_height; ?>px;">
		...
		$data_keys = array('layout', 'animation', 'bg_color', 'text_color', 'bg_image_url', 'bg_image_opacity', 'image_url', 'main_title', 'small_title', 'description', 'but_one_text', 'but_one_link', 'but_two_text', 'but_two_link', 'video_url');
